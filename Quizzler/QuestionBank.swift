...
//Store all of the questions, formatted using Question class

class QuestionBank
{
    //Array of objects from question class
    var list = [Question]()
    
    init()
    {
        // Creating a quiz item and appending it to the list
        //Item constructed using the Question initialization method
